...
public class ConcurrencyController<V> {
	 ...
	 */
//	
//	Map<Integer, Timestamp> read_timestamp = new HashMap<Integer, Timestamp>();
//	Map<Integer, Timestamp> write_timestamp = new HashMap<Integer, Timestamp>();
...
//		Timestamp latest_write = write_timestamp.get(dID);
//		if(write_timestamp.containsKey(dID))
//		{
//			
//			
//			if(latest_write.after(ts))
//			{
//				throw new AbortException();
//			}
//			
//			else if(latest_write.before(ts))
//			{
//				if(read_timestamp.containsKey(dID))
//				{
//					read_timestamp.remove(dID);
//					read_timestamp.put(dID, ts);
//				}
//			}
//		}
//		
...
//		{
//			
//			//Overwrite the last read time-stamp for the database object
//			if(read_timestamp.containsKey(dID))
//			{
//				read_timestamp.remove(dID);
//				read_timestamp.put(dID, ts);
